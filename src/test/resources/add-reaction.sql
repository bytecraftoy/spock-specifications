...
insert into Comment_Reactions (Comment_id, reactions_id) values (1, 1);
insert into Reaction (id, amount, type) values (2, 1, 'ANGRY');

insert into Comment_Reactions (Comment_id, reactions_id) values (1, 2);

insert into Comment (id, author, body) values (2, '', 'Your comment is not valid');
insert into Review_Comments (Review_id, comments_id) values (1, 1);

insert into Review_Comments (Review_id, comments_id) values (1, 2);
